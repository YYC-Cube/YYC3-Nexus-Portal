...
import { useModelProvider, type ModelEntry } from "./useModelProvider";
import { useSettingsStore } from "./useSettingsStore";

export type { ModelEntry } from "./useModelProvider";
...
export function useAIConfig(): UseAIConfigReturn {
  const { availableModels, ollamaLoading, ollamaUrl, setOllamaUrl, rescan, addModel, removeModel } =
    useModelProvider();
  ...
  return {
    ...
    availableModels, ollamaLoading, ollamaUrl, setOllamaUrl,
    rescanModels: rescan, addModel, removeModel,
