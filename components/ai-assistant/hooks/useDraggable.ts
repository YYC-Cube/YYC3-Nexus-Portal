...
export function useDraggable(options: UseDraggableOptions = {}): UseDraggableReturn {
  ...
  const handleEnd = useCallback(() => { setIsDragging(false); dragStartRef.current = null; }, []);
  ...
  return { position, isDragging, handleMouseDown, handleTouchStart, draggableRef, resetPosition };
}
